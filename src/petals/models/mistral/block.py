...
class WrappedMistralBlock(WrappedGQABlock, MistralDecoderLayer):
    """A Petals wrapper around a stock transformers ``MistralDecoderLayer`` (GQA + sliding window).

    See ``petals.models._gqa_block.WrappedGQABlock`` for the BLOOM-layout KV bridging rationale;
