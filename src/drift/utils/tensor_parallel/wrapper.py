...
via the thread-based ``parallel_apply_simple`` (correct on both CPU and CUDA). DRIFT-LLM always
...
from drift.utils.tensor_parallel.cross_device_ops import broadcast_coalesced
from drift.utils.tensor_parallel.slicer import Config
from drift.utils.tensor_parallel.utils import nested_flatten, nested_pack
