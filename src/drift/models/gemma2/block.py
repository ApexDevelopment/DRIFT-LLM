...
class WrappedGemma2Block(WrappedGemmaBlock, Gemma2DecoderLayer):
    """A DRIFT-LLM wrapper around a stock transformers ``Gemma2DecoderLayer``.

    See ``drift.models._gemma_block.WrappedGemmaBlock``: the alternating sliding/full attention
